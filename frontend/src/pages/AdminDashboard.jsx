  ...
  const fetchSiteSettings = async () => {
    try {
      ...
      setSiteSettings({
        ...
        ticker_text_uz: res.data.ticker_text_uz || res.data.ticker_text || "",
        ticker_text_ru: res.data.ticker_text_ru || "",
  ...
  const handleSaveSiteSettings = async () => {
    try {
      ...
      await api.patch("admin/site-settings/", {
        ...
        ticker_text: siteSettings.ticker_text_uz || siteSettings.ticker_text,
        ticker_text_uz: siteSettings.ticker_text_uz,
        ticker_text_ru: siteSettings.ticker_text_ru,
